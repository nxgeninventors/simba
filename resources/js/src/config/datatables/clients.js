    ...
    columns: [
...

        {
            ...
            defaultContent: `
                ...
                <button type="button" class="datatable-delete-btn delete text-gray-400 bg-transparent hover:bg-gray-200  rounded-lg text-sm p-1.5 inline-flex items-center dark:hover:bg-blue-600 dark:hover:text-white">
                    <i class="fa-regular fa-trash-can text-red-500"></i>
                </button>

                <button type="button" class="view_customer btn text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
                <i class="fa-regular fa-eye text-red-500"></i>
                </button>
            `,
        },
    ],
