<x-base-layout>
      ...
      <table width=90% height=30% border=2 style="border-collapse: collapse;margin: 0 auto;">
         ...
         <tr>
            <td width="50%" style="height: 30px;">
               ...
               <span><input type="text" id="purchase_number" name="purchase_number" value="" class="p-2.5 w-full rounded-lg text-gray-900 text-sm"></span>
            </td>
            <td width="50%" >
               <label for="Quotation_no" >Quotation No:</label>
               <span><input type="text" id="quotation_number" name="quotation_number" value="" class="p-2.5 w-full rounded-lg text-gray-900 text-sm"></span>
            </td>
         </tr>
         <tr>
            <td width="50%" style="height: 30px;">
               <label for="invoice_date" >Invoice Date:</label>
               <span><input type="date" id="date" name="invoice_date" class="p-2.5 w-full rounded-lg text-gray-900 text-sm"></span>
            </td>
            <td width="50%">
               <label for="Reference_no" >Reference No:</label>
               <span><input type="text" id="ref_no" name="reference_number" class="p-2.5 w-full rounded-lg text-gray-900 text-sm"></span>
            </td>
         </tr>
         <tr>
            <td width="50%" style="height: 30px;">
               <label for="Reverse_charge" >Reverse Charge:</label>
               <span><input type="text" id="reverse_charge" name="reverse_charge" value="" class="p-2.5 w-full rounded-lg text-gray-900 text-sm"></span>
            </td>
            <td width="50%">
               <label for="date_of_supply" >Date Of Supply:</label>
               <input type="date" id="date1" name="date_supply"  class="p-2.5 w-full rounded-lg text-gray-900 text-sm">
            </td>
         </tr>
         <tr>
            <td width="50%" style="height: 30px;">
               <label for="state" >State:</label>
               <span><select id="indian-state-select" name="state" class="p-2.5 w-full rounded-lg text-gray-900 text-sm"></select></span>
            </td>
            <td width="50%">
               <label for="place_of_supply" >Place of supply:</label>
               <span><input type="text" id="place_supply" name="place_supply" value="" class="p-2.5 w-full rounded-lg text-gray-900 text-sm"></span>
            </td>
         </tr>
         <tr>
      ...
      <table id="detailstable" width="90%" border="2" style="border-collapse: collapse;margin: 0 auto">
         ...
         <tbody id="input_field">
            <tr >
               ...
               <td><input type="text" id="gst" name="gst" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-20 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  >
      ...
      <button type="submit" id="pur_submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">add</button>
      <button type="submit" id="pur_del_btn" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Delete</button>
      </div>
      ...
      <table width="90%" border="1" style="border-collapse: collapse;margin: 0 auto">
         <tr>
            ...
            <td width="40%" rowspan="2" style="text-align: center;">
               <p>Ceritified that the particulars given above are true and correct</p>
   ...
   <button type="submit" id="pur_form" class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
      Add purchase
   </button>
