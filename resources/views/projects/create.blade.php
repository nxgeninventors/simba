<x-base-layout>
    ...
    <div class="py-12 data-ctrl" data-ctrl="ProjectsCtrl">
        <form method="POST" action="{{ url('meeting-notes') }}">
            @csrf
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100 min-h-screen">
                        <div class="mb-4">
                            ...
                            <x-text-input id="meeting_title" class="block mt-1 w-full" type="text" name="meeting_title" :value="old('meeting_title')" autofocus />
                            <x-input-error :messages="$errors->get('meeting_title')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="meeting_notes" :value="__('Meeting Notes')" />
                            <textarea id="tiny-meeting-notes" name="meeting_notes"></textarea>
